...
package dev.sculk.protocol.packet.inbound.status

import dev.sculk.protocol.Connection
import dev.sculk.protocol.PacketRegistry
...
class InboundStatusRequestPkt : InboundPacket {
    override val packetId: Int = 0x00

    override fun handle(connection: Connection) {
        connection.send(PacketRegistry.getPacketInstance(Boundedness.Outbound, ConnectionState.STATUS, 0x00) as OutboundPacket)
    }
}
